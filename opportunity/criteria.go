...
type Criteria struct {
	...
	XII            float32            `bson:"xii" json:"xii"`
	Cgpa           float32            `bson:"cgpa" json:"cgpa"`
	Branches       []constant.Branch  `bson:"branches" json:"branches"`
	ActiveBacklogs *int8              `bson:"activeBacklogs" json:"activeBacklogs"`
	TotalBacklogs  *int8              `bson:"totalBacklogs" json:"totalBacklogs"`
